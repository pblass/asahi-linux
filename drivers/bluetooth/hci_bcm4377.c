 ...
 * bar0_window0: Backplane address of the first window to be visible in BAR0
 * bar0_window1: Backplane address of the second window to be visible in BAR0
 * bar0_window5: Backplane address of the fifth window to be visible in BAR0
 * has_bar0_window5: Set to true if this chip requires window5 to be configured
